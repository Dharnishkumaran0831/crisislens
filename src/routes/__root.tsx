  ...
  head: () => ({
    meta: [
      ...
      { title: "CareerPilot AI — Your AI Career Copilot for Placement Success" },
      {
        name: "description",
        content:
          "CareerPilot AI is the all-in-one AI copilot for students: career counselling, resume analysis, mock interviews, roadmaps, DSA tracking, and placement analytics.",
      },
      { name: "author", content: "CareerPilot AI" },
      { property: "og:title", content: "CareerPilot AI — Your AI Career Copilot for Placement Success" },
      {
        property: "og:description",
        content:
          "Discover careers, sharpen your resume, ace interviews, and track placements — powered by AI.",
      },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "CareerPilot AI — Your AI Career Copilot for Placement Success" },
      { name: "description", content: "The all-in-one AI platform for students: career counselling, resume analyzer, mock interviews, roadmaps, DSA tracker, and placement analytics — from first year to first offer." },
      { property: "og:description", content: "The all-in-one AI platform for students: career counselling, resume analyzer, mock interviews, roadmaps, DSA tracker, and placement analytics — from first year to first offer." },
      { name: "twitter:description", content: "The all-in-one AI platform for students: career counselling, resume analyzer, mock interviews, roadmaps, DSA tracker, and placement analytics — from first year to first offer." },
